...
#define SWIG_init    Init_chaos_calendar
#define SWIG_name    "Chaos_calendar"

static VALUE mChaos_calendar;
...
SWIGEXPORT void Init_chaos_calendar(void) {
  ...
  SWIG_InitRuntime();
  mChaos_calendar = rb_define_module("Chaos_calendar");
  ...
  rb_define_module_function(mChaos_calendar, "occurrences", _wrap_occurrences, -1);
  rb_define_module_function(mChaos_calendar, "duration_to_fixnum", _wrap_duration_to_fixnum, -1);
}
